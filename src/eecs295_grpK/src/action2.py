...
################ danceMotionThree() ################
# Dance Motion 3: Tap foot
def danceMotionThree():
        initRobotPosition()

        moveCount = 0

        while(moveCount < 10):
                set MotorTargetPositionWrapper(3,522) # MAY NEED TO SWAP DIRECTIONS
                set MotorTargetPositionWrapper(3,512) # MAY NEED TO SWAP DIRECTIONS
        initMotorPosition(3)

        moveCount = 0

        while(moveCount < 10):
                set MotorTargetPositionWrapper(4,512) # MAY NEED TO SWAP DIRECTIONS
                set MotorTargetPositionWrapper(4,492) # MAY NEED TO SWAP DIRECTIONS
        initMotorPosition(4)
